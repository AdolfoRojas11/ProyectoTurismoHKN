  ...
  useEffect(() => {
    const obtenerUsuarios = async () => {
      const respuesta = await axios.get<ReporteUsuariosOut>(
        "http://localhost:4321/api/route/Obtener_Usuarios"
      );
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      <input
        ...
        className="mb-4 px-4 py-2 rounded border border-gray-300 text-black w-full max-w-md"
      />
