...
const LoginPage: React.FC = () => {
  ...
  async function ValidarCredenciales() {
    ...
    console.log("Datos que se enviarán al backend:", loginData); //

    try {
      const respuesta = await axios.post<LoginOut>(
        "http://localhost:4321/api/route/Validar_Credenciales_Usuario",
        loginData
      );
